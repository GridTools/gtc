...
# Automatic creation of pytest fixtures from maker functions in .common_definitions
for key, value in common_definitions.__dict__.items():
...
@pytest.fixture
def {name}_maker():
    yield common_definitions.make_{name}
