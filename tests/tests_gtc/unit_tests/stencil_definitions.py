...
valid_stencils = ["edge_reduction", "sparse_ex", "nested", "fvm_nabla", "temporary_field", "weighted_neighbor_reduction"]

def weighted_neighbor_reduction(mesh: Mesh, vertex_field : Field[Vertex, dtype], edge_field : Field[Vertex, dtype]):
